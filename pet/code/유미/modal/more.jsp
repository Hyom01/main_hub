                            ...
                            <form action="insert_adopt.jsp" method="get" enctype="multipart/form-data">
                                <table>
                                    <tbody>
                                        <tr>
                                            <th>이름</th>
                                            <td><input type="text" id="NAME" name="NAME" placeholder="입력하세요"></td>
                                        </tr>
                                        <tr>
                                            <th>전화 번호</th>
                                            <td><input type="text" id="PHONE" name="PHONE" placeholder="01012345678과 같은 형태로 입력하세요"></td>
                                        </tr>
                                        <tr>
                                            <th>방문 희망 시간</th>
                                            <td><input type="text" id="DAY" name="DAY" placeholder="2023/12/31와 같은 형태로 입력하세요"></td>
                                        </tr>
                                            <!-- pno 값 추가 -->
