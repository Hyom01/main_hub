...
class TermProject extends Component {
  ...
  render() {
    ...
    return (
      <Router>
        <Routes>
          <Route path="/" element={<Home count={count} IncreaseCount={this.handleButtonIncrease} DecreaseCount={this.handleButtonDecrease}/>} />
          <Route path="/Login" element={<OtherComponent />} />
        </Routes>
      </Router>
    );
  }
