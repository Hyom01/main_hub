...
<body>
    ...
    <section class="main">
        ...
        <div class="friend">
            <a href="../friends/friends.html"><img src="../img/friends.png"></a>
        </div>
        <div class="login">
            <%
            if(ID==null){%>
            ...
            <%}
                ...
                <div id="login-ing">
                    ...
                    <a id="login-ing-p"><%=ID%>님 로그인 중</a>
                    <p><a href="./logout.jsp" class="logout"><img src="../img/logout.png" alt="user-logout" id="user-logout"></a></p>   
                </div>
